...
--------------------------------------------------------------------------------------------------
 ...
 digital 2 - left up button ---> tempo divisions up
 digital 3 - left down button ---> tempo divisions down
  
 digital 4 - middle up button ---> next 3 midi notes
 digital 5 - middle up button ---> prev 3 midi notes
...
int HHcluster9[16] = {
  230,  26,  52,  24,  82,  28,  52, 118, 154,  26,  52,  24, 202, 212, 186, 196};        // config of the 9 clusters
